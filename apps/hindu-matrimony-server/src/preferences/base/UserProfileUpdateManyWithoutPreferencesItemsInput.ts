...
@InputType()
class UserProfileUpdateManyWithoutPreferencesItemsInput {
...
export { UserProfileUpdateManyWithoutPreferencesItemsInput as UserProfileUpdateManyWithoutPreferencesItemsInput };
