...
@InputType()
class UserProfileCreateNestedManyWithoutPreferencesItemsInput {
...
export { UserProfileCreateNestedManyWithoutPreferencesItemsInput as UserProfileCreateNestedManyWithoutPreferencesItemsInput };
