...
@InputType()
class PreferencesCreateNestedManyWithoutCommunitiesInput {
...
export { PreferencesCreateNestedManyWithoutCommunitiesInput as PreferencesCreateNestedManyWithoutCommunitiesInput };
