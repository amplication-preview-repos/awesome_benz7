...
@InputType()
class UserProfileCreateNestedManyWithoutCommunitiesInput {
...
export { UserProfileCreateNestedManyWithoutCommunitiesInput as UserProfileCreateNestedManyWithoutCommunitiesInput };
