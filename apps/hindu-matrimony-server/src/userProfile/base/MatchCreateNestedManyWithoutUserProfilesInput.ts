...
@InputType()
class MatchCreateNestedManyWithoutUserProfilesInput {
...
export { MatchCreateNestedManyWithoutUserProfilesInput as MatchCreateNestedManyWithoutUserProfilesInput };
